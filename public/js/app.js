...
$(window).on('mousemove touchmove', function (e) {
  ...
  if ($('.dropdown-content').is(':hover')) {} else {
...
var typewriter = new typewriter_effect_dist_core__WEBPACK_IMPORTED_MODULE_1___default.a(writer, {
  loop: true,
  delay: 40
});
typewriter.typeString('I am Erik Wubbels, user experience designer and web developer.').pauseFor(400).typeString(' Scroll down to view some of my projects. ').pauseFor(400).typeString('<a href="/about">Or click here to read more about me.</a>').pauseFor(60000).start(); // Lazy Load Images
// $(function() {
//     $('.lazy').lazy();
// });
// Service Worker
...
__webpack_require__(/*! /var/www/portfolio2/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/portfolio2/resources/sass/app.scss */"./resources/sass/app.scss");
