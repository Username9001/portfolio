...
@section('content')
    ...
    <div id="projects" class="project-block">
        ...
        <div class="project-grid">
            <a href="/projects/holdie" id="holdie-project" class="project-item project-item1"  data-aos="fade-up-right" data-aos-duration="1400" data-aos-easing="ease-in-out" data-aos-anchor-placement="top-bottom">
            ...
            <a href="/projects/helios" id="helios-project" class="project-item project-item2" data-aos="fade-down" data-aos-duration="1400" data-aos-easing="ease-in-out" data-aos-anchor-placement="top-bottom">
                <div class="text-block">
                    <h2>Helios</h2>
                    <hr>
            ...
            <a href="/projects/olio" id="olio-project" class="project-item project-item4" data-aos="fade-up" data-aos-duration="1400" data-aos-easing="ease-in-out" data-aos-anchor-placement="top-bottom">
                <div class="text-block">
                    <h2>Olio</h2>
                    <hr>
            ...
            <a href="/projects/bfs" id="test1-project" class="project-item project-item5" data-aos="fade-down-right" data-aos-duration="1400" data-aos-easing="ease-in-out" data-aos-anchor-placement="top-bottom">
                <div class="text-block">
                    <h2>Formgiving</h2>
                    <hr>
            ...
            <a href="/projects/escaperoom" id="escaperoom-project" class="project-item project-item6" data-aos="fade-up-left" data-aos-duration="1400" data-aos-easing="ease-in-out" data-aos-anchor-placement="top-bottom">
                <div class="text-block">
                    <h2>Escape Room</h2>
                    <hr>
